...
//     * @param refreshToken The refresh token.
     ...
     */
    public AuthenticationResponse(String accessToken, boolean mfaEnabled) {
        this(accessToken, mfaEnabled, null, null);
    }
...
//     * @param refreshToken   The refresh token.
     ...
     */
    public AuthenticationResponse(String accessToken, boolean mfaEnabled, String secretImageUri, String userName) {
